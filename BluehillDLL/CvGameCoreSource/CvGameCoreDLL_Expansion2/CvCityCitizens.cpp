...
int CvCityCitizens::GetSpecialistUpgradeThreshold(UnitClassTypes eUnitClass)
{
	...
	{
		iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatWritersCreated(GC.getGame().isOption(GAMEOPTION_TRULY_FREE_GP));
	}
	else if (eUnitClass == GC.getInfoTypeForString("UNITCLASS_ARTIST", true))
	{
		iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatArtistsCreated(GC.getGame().isOption(GAMEOPTION_TRULY_FREE_GP));
	}
	else if (eUnitClass == GC.getInfoTypeForString("UNITCLASS_MUSICIAN", true))
	{
		iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatMusiciansCreated(GC.getGame().isOption(GAMEOPTION_TRULY_FREE_GP));
	}
	else
	{
		if (GC.getGame().isOption(GAMEOPTION_SEPARATE_GP_COUNTERS))
		{
			...
			{
				iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatMerchantsCreated(GC.getGame().isOption(GAMEOPTION_TRULY_FREE_GP));
			}
			else if (eUnitClass == GC.getInfoTypeForString("UNITCLASS_SCIENTIST", true))
			{
				iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatScientistsCreated(GC.getGame().isOption(GAMEOPTION_TRULY_FREE_GP));
			}
			else
			{
				iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatEngineersCreated(GC.getGame().isOption(GAMEOPTION_TRULY_FREE_GP));
			}
		}
		else
		{
			iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatPeopleCreated(GC.getGame().isOption(GAMEOPTION_TRULY_FREE_GP));
		}
	}
