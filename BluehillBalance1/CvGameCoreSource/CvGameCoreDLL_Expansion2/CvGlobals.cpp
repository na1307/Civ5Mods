...
CvGlobals::CvGlobals() :
    ...
    m_iMINOR_BULLY_GOLD_GROWTH_FACTOR(450),
    m_iMINOR_RECENTLY_BULLIED_TURN_INTERVAL(20),
    ...
    m_iMINOR_FRIENDSHIP_DROP_PER_TURN_FRIENDLY(-50),
    ...
    m_iFRIENDSHIP_PER_BARB_KILLED(20),
    ...
    m_iMINOR_CIV_QUEST_ROUTE_MAX_DISTANCE(8),
    m_iMINOR_CIV_QUEST_CONTEST_CULTURE_PLAYERS_NEEDED(3),
    m_iMINOR_CIV_QUEST_CONTEST_FAITH_PLAYERS_NEEDED(3),
    m_iMINOR_CIV_QUEST_CONTEST_TECHS_PLAYERS_NEEDED(3),
    m_iMINOR_CIV_QUEST_INVEST_PLAYERS_NEEDED(2),
    ...
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_HOSTILE_BULLY_CITY_STATE(200),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_IRRATIONAL_BULLY_CITY_STATE(350),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_BULLY_CITY_STATE(300),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_DENOUNCE_MAJOR(250),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_DENOUNCE_MAJOR(200),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_DENOUNCE_MAJOR(150),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_SPREAD_RELIGION(300),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_TRADE_ROUTE(200),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_TRADE_ROUTE(200),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_CULTURED_CONTEST_CULTURE(200),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_CONTEST_FAITH(200),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_CONTEST_FAITH(50),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_CONTEST_TECHS(50),
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_INVEST(150),
    ...
    m_iOPINION_WEIGHT_EMBASSY(-2),
    m_iOPINION_WEIGHT_EMBASSY_THEM(-1),
    m_iOPINION_WEIGHT_DIPLOMAT(-10),
    m_iOPINION_WEIGHT_OPEN_BORDERS_US(-5),
    ...
    m_iMINOR_CIV_CONTACT_FAITH_FIRST(8),
    m_iMINOR_CIV_CONTACT_FAITH_OTHER(4),
    ...
    m_iMINOR_GOLD_GIFT_INVEST_BOOST_PERCENTAGE(50),
    m_iMINOR_CIV_TILE_IMPROVEMENT_GIFT_COST(200),
    m_iMINOR_CIV_BUYOUT_COST(500),
    m_iMINOR_CIV_BUYOUT_TURNS(5),
    m_iMINOR_REPROTECT_GRACE_PERIOD(20),
    m_iMINOR_UNPROTECT_GRACE_PERIOD(10),
...
void CvGlobals::cacheGlobals()
{
    ...
    m_iMINOR_BULLY_GOLD_GROWTH_FACTOR = getDefineINT("MINOR_BULLY_GOLD_GROWTH_FACTOR");
    m_iMINOR_RECENTLY_BULLIED_TURN_INTERVAL = getDefineINT("MINOR_RECENTLY_BULLIED_TURN_INTERVAL");
    ...
    m_iMINOR_FRIENDSHIP_DROP_PER_TURN_FRIENDLY = getDefineINT("MINOR_FRIENDSHIP_DROP_PER_TURN_FRIENDLY");
    ...
    m_iMINOR_CIV_QUEST_ROUTE_MAX_DISTANCE = getDefineINT("MINOR_CIV_QUEST_ROUTE_MAX_DISTANCE");
    m_iMINOR_CIV_QUEST_CONTEST_CULTURE_PLAYERS_NEEDED = getDefineINT("MINOR_CIV_QUEST_CONTEST_CULTURE_PLAYERS_NEEDED");
    m_iMINOR_CIV_QUEST_CONTEST_FAITH_PLAYERS_NEEDED = getDefineINT("MINOR_CIV_QUEST_CONTEST_FAITH_PLAYERS_NEEDED");
    m_iMINOR_CIV_QUEST_CONTEST_TECHS_PLAYERS_NEEDED = getDefineINT("MINOR_CIV_QUEST_CONTEST_TECHS_PLAYERS_NEEDED");
    m_iMINOR_CIV_QUEST_INVEST_PLAYERS_NEEDED = getDefineINT("MINOR_CIV_QUEST_INVEST_PLAYERS_NEEDED");
    ...
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_HOSTILE_BULLY_CITY_STATE = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_HOSTILE_BULLY_CITY_STATE");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_IRRATIONAL_BULLY_CITY_STATE = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_IRRATIONAL_BULLY_CITY_STATE");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_BULLY_CITY_STATE = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_BULLY_CITY_STATE");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_DENOUNCE_MAJOR = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_DENOUNCE_MAJOR");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_DENOUNCE_MAJOR = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_DENOUNCE_MAJOR");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_DENOUNCE_MAJOR = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_DENOUNCE_MAJOR");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_SPREAD_RELIGION = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_SPREAD_RELIGION");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_TRADE_ROUTE = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_TRADE_ROUTE");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_TRADE_ROUTE = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_TRADE_ROUTE");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_CULTURED_CONTEST_CULTURE = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_CULTURED_CONTEST_CULTURE");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_CONTEST_FAITH = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_CONTEST_FAITH");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_CONTEST_FAITH = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_CONTEST_FAITH");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_CONTEST_TECHS = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_CONTEST_TECHS");
    m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_INVEST = getDefineINT("MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_INVEST");
    ...
    m_iMINOR_CIV_CONTACT_FAITH_FIRST = getDefineINT("MINOR_CIV_CONTACT_FAITH_FIRST");
    m_iMINOR_CIV_CONTACT_FAITH_OTHER = getDefineINT("MINOR_CIV_CONTACT_FAITH_OTHER");
    ...
    m_iMINOR_GOLD_GIFT_INVEST_BOOST_PERCENTAGE = getDefineINT("MINOR_GOLD_GIFT_INVEST_BOOST_PERCENTAGE");
    ...
    m_iMINOR_REPROTECT_GRACE_PERIOD = getDefineINT("MINOR_REPROTECT_GRACE_PERIOD");
    m_iMINOR_UNPROTECT_GRACE_PERIOD = getDefineINT("MINOR_UNPROTECT_GRACE_PERIOD");
