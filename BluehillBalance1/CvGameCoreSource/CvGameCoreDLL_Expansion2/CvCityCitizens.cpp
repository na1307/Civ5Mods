...
int CvCityCitizens::GetSpecialistUpgradeThreshold(UnitClassTypes eUnitClass)
{
    ...
    {
        iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatWritersCreated(true);
    }
    else if (eUnitClass == GC.getInfoTypeForString("UNITCLASS_ARTIST", true))
    {
        iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatArtistsCreated(true);
    }
    else if (eUnitClass == GC.getInfoTypeForString("UNITCLASS_MUSICIAN", true))
    {
        iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatMusiciansCreated(true);
    }
    else if (eUnitClass == GC.getInfoTypeForString("UNITCLASS_MERCHANT", true))
    {
        iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatMerchantsCreated(true);
    }
    else if (eUnitClass == GC.getInfoTypeForString("UNITCLASS_SCIENTIST", true))
    {
        iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatScientistsCreated(true);
    }
    else if (eUnitClass == GC.getInfoTypeForString("UNITCLASS_ENGINEER", true))
    {
        iNumCreated = GET_PLAYER(GetCity()->getOwner()).getGreatEngineersCreated(true);
    }
    else
    {
        // This is should not running
        return 0;
    }
