...
public:
    ...
    bool canRaze(CvCity *pCity, bool bIgnoreCapitals = false, bool bIgnoreOwnership = false) const;
    ...
    int GetAllFeatureFood() const;
    void ChangeAllFeatureFood(int iChange);
    ...
    int getFeatureFoodModifier() const;
    void changeFeatureFoodModifier(int iChange);
    ...
    CvPlayerAchievements &GetPlayerAchievements() {
        return m_kPlayerAchievements;
    }
...
protected:
    ...
    FAutoVariable<int, CvPlayer> m_iFeatureFoodModifier;
    ...
    FAutoVariable<int, CvPlayer> m_iAllFeatureFood;
